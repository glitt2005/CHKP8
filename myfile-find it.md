...
-   Cuando se crea la instancia  `miCoche`, se pasan los valores  `'Toyota'`,  `'Corolla'`  y  `2020`  al constructor.
-   El constructor asigna estos valores a las propiedades del objeto, usando  `this.marca`,  `this.modelo`  y  `this.año`.
- Ignora la propiedad año que el constructor contiene por defecto. Ésta, `'año': 2019` , solo hubiera salido si al pasar los parámentros en la instancia n**o hubiera incluido el valor para `'año'`**, es decir: `const miCoche = new Coche('Toyota', 'Corolla');`// imprimirá: 
## 2. MÉTODOS ESTÁTICOS
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTY3NjAyMTkyOCw0MDE0NDAzNjksMjAzOD
