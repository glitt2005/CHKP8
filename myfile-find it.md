...
#### VENTAJA: 
Nos evita tener la tediosa tarea de uno, por uno, cambiar ede cada uno de los jugadores `jugadorx.nombre`
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTM4NTYwNzY5OSwzMTg1NjQwNDgsLTkwND
