...
-  **Devuelve una promesa** que resuelve al objeto `Response`, que representa la respuesta a ua respuesta a la solicitud realizada.
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE1OTA3NDAwNSwtOTE3MDY4NTA3LC03OD
