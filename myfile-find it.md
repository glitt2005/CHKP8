...
5.	 Creamos dos métodos de `setTimeout()`, cada uno de ellos contendrá sendos métodos:
	 - `resolve(valor)` 
	 - 
		6.	
7.		Creamos dos argumentos al método `setTimeout()`:
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTExODY3MTEzNzcsOTU3NzQ3NDI2LC0xND
