...
**NOTA**: Debemos llamar a la función siempre teniendo en cuenta **el tipo de datos que contiene**. En el Ejemplo 2, vemos que la función  `mostrarNumeros()` contiene una array: `[primero, segundo]`, y por tanto, cuando la invoquemos debemos poner los parámetros en formato 
####  VALORES POR DEFECTO:
...
```
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTkyNDczMTY5MSwxMTI0NzI4NTc5LDY1Nj
